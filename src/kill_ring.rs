...
mod tests {
    ...
    fn test_push_and_peek() {
        ...
        kr.push("hello", &PushOptions { prepend: false, accumulate: false });
    ...
    fn test_accumulate_append() {
        let mut kr = KillRing::new();
        kr.push("hello", &PushOptions { prepend: false, accumulate: false });
        kr.push(" world", &PushOptions { prepend: false, accumulate: true });
    ...
    fn test_accumulate_prepend() {
        let mut kr = KillRing::new();
        kr.push("world", &PushOptions { prepend: false, accumulate: false });
        kr.push("hello ", &PushOptions { prepend: true, accumulate: true });
        assert_eq!(kr.peek(), Some("hello world"));
    }
    ...
    fn test_rotate() {
        let mut kr = KillRing::new();
        kr.push("a", &PushOptions { prepend: false, accumulate: false });
        kr.push("b", &PushOptions { prepend: false, accumulate: false });
        kr.push("c", &PushOptions { prepend: false, accumulate: false });
